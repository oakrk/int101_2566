...
public class Int101Homework01 {
    ...
    public static void main(String[] args) {
        work01Question(true, false, true, true, true, false);
        work01Answer(true, false, true, true, true, false);
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
      //weight = kg, height = cm
      System.out.println("Work03: calcuate BMI = "+MyUtil.calculateBMI(71, 173));
      System.out.println("Work03: average = "+MyUtil.average(2, 2, 2)); 
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
    Person oak = new Person(1234); //Create a new object called Person.
    Person now = new Person(4321); //Create a new object called Person.
    BankAccount oakBankAccount = new BankAccount(134532, oak, 100); //Create a new object called BankAccount.
    BankAccount nowBankAccount = new BankAccount(342342, now, 100); //Create a new object called BankAccount.
    System.out.println("------------------------------------------------------------");
    System.out.println(oak);
    System.out.println(oakBankAccount);
    System.out.println(now);
    System.out.println(nowBankAccount);
    System.out.println("---------------------------deposit---------------------------");
    System.out.println("before (oak): "+oakBankAccount.getBalance());
    System.out.println("new value: "+oakBankAccount.deposit(100)); //try to deposit.
    System.out.println("after (oak): "+oakBankAccount.getBalance());
    System.out.println("---------------------------withdraw--------------------------");
    System.out.println("before (now): "+nowBankAccount.getBalance());
    System.out.println("new value: "+nowBankAccount.withdraw(50)); //try to withdraw.
    System.out.println("after (now): "+nowBankAccount.getBalance());
    System.out.println("---------------------------tranfer---------------------------");
    System.out.println("now: "+nowBankAccount.getBalance()+" "+"oak: "+oakBankAccount.getBalance());
    oakBankAccount.transfer(50, nowBankAccount); //try to tranfer from oak to now.
    System.out.println("now: "+nowBankAccount.getBalance()+" "+"oak: "+oakBankAccount.getBalance());
    System.out.println("-------------------------------------------------------------");
   }
}
