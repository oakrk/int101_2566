...
public class Int101Homework02Updated {
    ...
    static void work01Utilitor() {
        ...
        System.out.println(Utilitor.testString("oak!"));
        try {
        ...
        try {
            System.out.println(Utilitor.testPositive(100));
            System.out.println(Utilitor.testPositive(-1));
        } catch (Exception e) {
            System.out.println(e);
        }
        System.out.println(Utilitor.computeIsbn10(999215810));
    ...
    static void work02Person() {
         ...
         */
        System.out.println(Utilitor.testString("--------------------------------------------------"));
        Person person1 = new Person("Ratchapon", "Klinprathum");
        Person person2 = new Person("test", "test");
    ...
    static void work03Account() {
        ...
        System.out.println("account1 deposit 50 balance: "+account1.deposit(50));
        System.out.println("account1 deposit 50 balance: "+account1.deposit(50));
        System.out.println("account1 withdraw 50 balance: "+account1.withdraw(50));
        try {
            System.out.println("try to withdraw 100: ");
        } catch (Exception e) {
            System.out.println(e);
        }
